...
class OrdersNotifier extends StateNotifier<OrdersState> {
  ...
  Future<OrderSummariesPage> _loadOrderPage({int offset = 0}) async {
    if (_isCashierRestrictedView) {
      ...
      final List<OpenOrderSummary> activeOrders =
          await orderService.getActiveOrderSummaries();
      final List<OpenOrderSummary> recentPaid =
          await orderService.getRecentPaidOrdersForToday(
            limit: _cashierRecentPaidLimit,
          );
